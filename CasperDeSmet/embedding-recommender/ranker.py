...
class EmbeddingRanker:
    ...
    def evaluate(self, predictions):
        purchases = get_purchases(self.transactions[self.transactions.week == self.test_week])
    ...
    def get_rank_method(self, method):
        match method:
            ...
            case "weight_popular": return self.rank_customer_weight_popular
    ...
    def rank_customer_add_popular(self, customer_id):
        transactions = self.popular_data[["embedding", "week"]].head(12)
        if customer_id in self.grouped_transactions.groups:
            # retrieve all customer transactions
    ...
    # NOT IMPLEMENTED YET
    def rank_customer_weight_popular(self, customer_id):
        customer_embedding = None
        if customer_id in self.grouped_transactions.groups:
            # retrieve all customer transactions
            transactions = self.grouped_transactions.get_group(customer_id)
