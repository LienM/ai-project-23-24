...
def prune_outdated_items(articles_df: pd.DataFrame, transactions_df: pd.DataFrame, cutoff_days: int = 180) -> (pd.DataFrame, pd.DataFrame):
    """
    Prunes items that have not been purchased in the last 6 months.
